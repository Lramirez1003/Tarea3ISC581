...
public class ProductoDB {
    ...
    public void insert(String name, int price, int marca, String baseImage){
    ...
    public void update(Integer id, String name, int price, int marca, String baseImage){
        ContentValues values = new ContentValues();
        values.put(DBHelper.NAME, name);
        values.put(DBHelper.PRICE, price);
        values.put("MARCA", marca);
